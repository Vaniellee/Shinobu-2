...
messagef.edit({content: "<:musician_blue:1053409817491935282> | The song is over if you want to hear it again I'll be here for you.", embeds: [], components: []}).catch(err => {})
})
})
})
...
interaction.reply({content: "Bassboost online!", ephemeral: true})
  ...
  if (interaction.customId === "soru") {
    ...
    const embed = new Discord.EmbedBuilder()
        ...
        .addFields({ name: 'Singing the music:', value: `[${queue.songs[0].uploader.name}](${queue.songs[0].uploader.url})`, inline: true })
        ...
        .addFields({ name: `Duration of the music: **[${queue.formattedCurrentTime} / ${queue.songs[0].formattedDuration}]**`, value: ` ${'<:green_middle_bar_awoken:1053412306249330720>'.repeat(part) + '<a:shinobu_EpicDance:1053414267698827314>' + '<:green_middle_bar_awoken:1053412306249330720>'.repeat(20 - part)}`, inline: false })
